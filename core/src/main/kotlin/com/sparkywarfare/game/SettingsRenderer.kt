...
class SettingsRenderer(
    ...
    private fun command(r:Rectangle,t:String,s:String,tc:Color,sc:Color){
        ...
        text.fit(titleFont,t,r.width-46f,0.66f,0.48f);text.centered(titleFont,t,cx,r.y+r.height*0.66f,tc)
        text.fit(bodyFont,s,r.width-46f,0.6f,0.42f);text.centered(bodyFont,s,cx,r.y+r.height*0.25f,sc)
    }
}
