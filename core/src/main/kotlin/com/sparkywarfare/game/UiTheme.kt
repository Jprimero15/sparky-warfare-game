...
object UiTheme {
    val PANEL = Color(0.028f, 0.045f, 0.095f, 0.46f)
    val PANEL_DARK = Color(0.010f, 0.020f, 0.055f, 0.54f)
    val INNER = Color(0.075f, 0.10f, 0.18f, 0.42f)
    val CARD = Color(0.050f, 0.075f, 0.145f, 0.44f)
    ...
    val WORLD_BACKDROP = Color(0.006f, 0.009f, 0.028f, 1f)
    val WORLD_FLOOR = Color(0.018f, 0.030f, 0.050f, 1f)
    val WORLD_CYAN_POOL = Color(0.02f, 0.42f, 0.50f, 0.045f)
    val WORLD_VIOLET_POOL = Color(0.44f, 0.10f, 0.52f, 0.035f)
    val WALL_STEEL = Color(0.045f, 0.075f, 0.115f, 1f)
    val WALL_CYAN = Color(0.035f, 0.100f, 0.130f, 1f)
    val WALL_VIOLET = Color(0.115f, 0.035f, 0.125f, 1f)
    val WALL_BLUE = Color(0.065f, 0.080f, 0.125f, 1f)
    val GOLD = Color(1f, 0.74f, 0.3f, 1f)
    val BLACK = Color(0f, 0f, 0f, 1f)
    val SHADOW = Color(0f, 0f, 0f, 0.70f)

    val OVERLAY = Color(0.004f, 0.008f, 0.026f, 0.40f)
    val PANEL_EDGE = Color(0.30f, 0.94f, 1f, 0.22f)
    val GLASS_HIGHLIGHT = Color(1f, 1f, 1f, 0.075f)
    val GLASS_SHADOW = Color(0f, 0f, 0f, 0.12f)
    val CYAN_GLOW = Color(0.22f, 0.96f, 1f, 0.065f)
    val MAGENTA_GLOW = Color(0.84f, 0.34f, 1f, 0.05f)
